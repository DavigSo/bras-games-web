...
router.post('/cart/addToCart', (req, res) => cartController.addToCart(req, res));
...
router.get('/cart/getCartDetails/:cartId', (req, res) => cartController.getCartDetails(req, res));
